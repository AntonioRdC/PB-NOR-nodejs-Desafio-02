...
CREATE TABLE `residence` (
  ...
  KEY `fk_residencia_responsavel_idx` (`responsible_id`),
  CONSTRAINT `fk_residencia_responsavel` FOREIGN KEY (`responsible_id`) REFERENCES `responsible` (`id`)
);
...
CREATE TABLE `cleaning` (
  ...
  KEY `fk_diarista_has_residencia_residencia1_idx` (`residence_id`),
  KEY `fk_diarista_has_residencia_diarista1_idx` (`diarist_id`),
  CONSTRAINT `fk_diarista_has_residencia_diarista1` FOREIGN KEY (`diarist_id`) REFERENCES `diarist` (`id`),
  CONSTRAINT `fk_diarista_has_residencia_residencia1` FOREIGN KEY (`residence_id`) REFERENCES `residence` (`id`)
);
